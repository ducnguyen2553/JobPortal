        ...
        <>
            <section className="pt-24 pb-16 bg-white min-h-screen flex items-center">
                    ...
                    <div className="max-w-4xl mx-auto text-center">
                        ...
                        >
                            ...
                            <motion.button
                                ...
                                hover:border-gray-300 hover:bg-gray-50 transition-all duration-300 shadow-sm hover:shadow-md"
                                onClick={() => {
                                    navigate(
                        ...
                        >
                            {stats.map((stat, index) => (
                                <motion.div
                                    ...
                                    className="flex flex-col items-center space-x-2 p-4 rounded-xl hover:bg-gray-50 transition-colors"
                                >
                ...
                <div className="absolute inset-0 overflow-hidden pointer-events-none">
                    ...
                    <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-96 h-96 bg-gradient-to-r from-blue-50 to-purple-50
                    blur-3xl rounded-full opacity-20
                    " />
                </div>
            </section>
        </>
