          ...
          <div className="bg-white shadow-xl rounded-2xl p-6">
              ...
              <div className="flex items-center space-x-2">
                <button
                  ...
                  className="group flex items-center space-x-2 px-6 py-3 text-sm font-medium text-gray-600 hover:text-white bg-white/50 
                              hover:bg-gradient-to-r hover:from-blue-500 hover:to-blue-600 border border-gray-200 hover:border-transparent rounded-xl transition-all duration-300 
            ...
            <div className="space-y-6">
              ...
              <TextareaField
                label="Requirements"
                id="requirements"
                placeholder="List ket qualifications and skills..."
                ...
                <div className="grid grid-cols-3 gap-3">
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="w-full pl-10 pr-3 py-2.5 border border-gray-300 rounded-lg text-base focus:outline-none
                       focus:ring-2 focus:ring-blue-500 focus:ring-opacity-20 focus:border-blue-500 transition-colors duration-200"
                    />
                  </div>
            ...
            <div className="pt-2">
              <button
                ...
                className="w-full flex items-center justify-center px-4 py-3 border border-transparent text-base font-medium rounded-lg
                           text-white bg-blue-600 hover:bg-blue-700 focus:outline-none focus:ring-offset-2 focus:ring-blue-50
                           disabled:bg-gray-400  disabled:cursor-not-allowed outline-none transition-colors duration-200"
              >
                {isSubmitting ? (
                  <>
