    ...
    <tr className="animate-pulse">
      <td className="px-6 py-4">
        <div className="flex items-center space-x-3">
          <div className="w-10 h-10 bg-ray-200 rounded-full"></div>
    ...
    <DashboardLayout activeMenu="manage-jobs">
      <div className="min-h-screen p-4 sm:p-6 lg:p-8">
        <div className="max-w-7xl mx-auto">
            ...
            <div className="flex flex-row items-center justify-between">
              <div className="mb-4 sm:mb-0">
                ...
                <p className="text-sm text-gray-600 mt-1">
                  Manage your jon posting and track applications
                </p>
              </div>

              <button
                className="inline-flex items-center px-6 py-3 bg-gradient-to-r from-blue-600 to-blue-700 hover:from-blue-700 hover:to-blue-700 text-sm text-white font-semibold rounded-xl
                           shadow-lg shadow-blue-500/25 hover:shadow-xl hover:shadow-blue-500/300 transition-all duration-300
          ...
          {/* Filters */}
          <div className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-2xl shadow-black/5 border border-white/20 p-6 mb-8">
                  ...
                  <table className="min-w-full divide-y divide-gray-200">
                    <thead className="bg-gradient-to-r from-gray-50 to-gray-100/50">
                      <tr>
                        ...
                        <th
                          className="px-6 py-4 text-left text-xs font-semibold text-gray-600 uppercase tracking-wider cursor-pointer
                                     hover:bg-gray-100/60 transition-all duration-200 min-w-[130px] sm:min-w-0"
                        ...
                        <th className="px-6 py-4 text-left text-xs font-semibold text-gray-600 uppercase tracking-wider min-w-[190px] sm:min-w-0">
                          Actions
                        </th>
                      </tr>
                    </thead>
                    <tbody className="bg-white divide-y divide-gray-200">
                      {isLoading
                        ...
                        : paginatedJobs.map((job) => (
                          <tr className="hover:bg-blue-50/30 transition-all duration-200 border-b border-gray-100/60"
                            key={job.id}
                          >
                            ...
                            <td className="py-6 px-5 whitespace-nowrap min-w-[120px] sm:min-w-0">
                              <span
                                className={`inline-flex px-3 py-1.5 rounded-full font-semibold text-xs
                                ${job.status === "Active"
                            ...
                            <td className="py-6 px-5 whitespace-nowrap min-w-[130px] sm:min-w-0">
                              <button
                                className="flex items-center text-sm text-blue-600 hover:text-blue-800 font-semibold transition-colors duration-200
                                           hover:bg-blue-50 px-2 py-1 rounded-lg"
                            ...
                            <td className="py-6 px-5 whitespace-nowrap min-w-[180px] sm:min-w-0">
                              <div className="flex space-x-2">
                                <button
                                ...
                                {job.status === "Active" ? (
                                  <button
                                    className="flex items-center gap-2 text-xs text-orange-600 hover:text-orange-800 p-2 hover:bg-orange-50 transition-colors duration-200"
            ...
            {totalPages > 1 && (
              <div className="mt-6 flex items-center justify-between">
                <div className="flex-1 flex justify-between sm:hidden">
                  ...
                  <button
                    className="relative ml-3 inline-flex items-center px-4 py-2 border border-gray-300 text-sm font-medium rounded-ms text-gray-700 bg-white
                ...
                <div className="hidden sm:flex-1 sm:flex sm:items-center sm:justify-between">
                  ...
                  <div>
                    <nav className="relative z-0 inline-flex rounded-md shadow-md -space-x-px">
                      ...
                      <button
                        className="relative inline-flex items-center px-2 py-2 rounded-r-md border border-gray-300 bg-white text-sm font-medium text-gray-50
                               hover:bg-gray-50 disabled:opacity-50 disabled:cursor-not-allowed"
                        onClick={() => setCurrentPage(Math.min(totalPages, currentPage + 1))}
                        disabled={currentPage === totalPages}
                      >
