...
const UserProfile = () => {
  ...
  const handleSave = async () => {
    ...
    try {
      const response = await axiosInstance.post(API_PATHS.AUTH.UPDATE_PROFILE, formData);
                  ...
                  <div>
                    <label className="block">
                      ...
                      <input
                        ...
                        className="block w-full text-sm text-gray-500 file:mr-4 file:py-2 file:px-4 file:rounded-full file:border-0 file:font-semibold file:bg-blue-50
