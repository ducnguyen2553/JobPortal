...
const jobDetails = () => {
  ...
  const applyToJob = async () => {
    try {
      ...
      toast.error(errorMsg || "Something went wrong! Try again late");
    }
  };
        ...
        {jobDetails && (
          <div className="bg-white p-6 rounded-lg">
              ...
              <div className="relative z-10">
                <div className="flex items-center gap-3 mb-6">
                  ...
                  {jobDetails?.applicationStatus ? (
                    ...
                    <button
                      className="bg-gradient-to-r from-blue-50 to-blue-50 text-blue-700 hover:text-white px-6 py-2.5 rounded-xl 
                        hover:from-blue-500 hover:to-blue-600 transition-all duration-200 font-semibold transform hover:-translate-x-0.5"
                      onClick={applyToJob}
                    >
                      Apply Now
                    </button>
            ...
            <div className="space-y-4">
              ...
              <div className="bg-gradient-to-br from-purple-50 to-pink-50 border border-purple-100 rounded0xl px-6">
                <div className="text-sm text-gray-700 leading-relaxed whitespace-pre-wrap">
