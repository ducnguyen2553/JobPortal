...
const SignUp = () => {
  ...
  const handleInputChange = (e) => {
    ...
    // nếu field đang có lỗi, xóa thông báo lỗi khi user gõ lại
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="flex items-center space-x-4">
                ...
                <div className="flex-1">
                  ...
                  <label htmlFor="avatar"
                    className="cursor-pointer bg-gray-100 border border-gray-300 rounded-lg px-4 py-2 text-sm font-medium text-gray-700 hover:bg-gray-50  transition-colors flex items-center space-x-2"
                  >
            ...
            <button
              ...
              className="w-full bg-gradient-to-r from-blue-600 to-purple-600 text-white py-3 rounded-lg font-semibold 
                ...
                flex items-center justify-center space-x-2 my-3
                "
            >
              {formState.loading ? (
                <>
