        ...
        <>
            <div className="flex h-screen bg-gray-50">
                ...
                <div className={`fixed inset-y-0 left-0 z-50 transition-transform duration-300 transform ${isMobile
                    ...
                    {/* Company Logo*/}
                    <div className="flex items-center h-16 border-b-2 border-gray-200 pl-6">
                        {!sidebarCollapsed ? (
                    ...
                    <div className="absolute bottom-4 left-4 right-4 ">
                        <button className="w-full flex items-center px-3 py-2.5 text-sm font-medium rounded-lg text-gray-700
                             hover:bg-gray-50 hover:text-gray-900 hover:font-bold transition-all duration-300 cursor-pointer"
                            onClick={logout}
                        >
                ...
                {isMobile && sidebarOpen && (
                    <div className="fixed inset-0 bg-track bg-opacity-25 z-40 backdrop-blur-sm"
