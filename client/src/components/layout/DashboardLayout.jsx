      ...
      <div className="flex h-screen bg-gray-50">
        ...
        >
          ...
          <div className="absolute bottom-4 left-4 right-4 ">
            <button
              className="w-full flex items-center px-3 py-2.5 text-sm font-medium rounded-lg text-gray-700
        ...
        {isMobile && sidebarOpen && (
          <div
            className="fixed inset-0 bg-track bg-opacity-25 z-40 backdrop-blur-sm"
