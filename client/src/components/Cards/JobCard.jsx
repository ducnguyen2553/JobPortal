...
const JobCard = ({ job, onClick, onToggleSave, onApply, saved, hideApply }) => {
    ...
    return (
        <div className=" relative bg-white rounded-2xl border-gray-200 p-6 hover:shadow-xl hover:shadow-gray-200 transition-all duration-300 group overflow-hidden cursor-pointer"
            onClick={onClick}>
                ...
                <div className="flex items-start gap-4">
                    {job?.company?.companyLogo ? (
                        ...
                        <div className="w-14 h-14 bg-gray-50 border-2 border-gray-200 rounded-2xl flex items-center justify-center">
                            <Building2 className="h-8 w-7 text-gray-400" />
                        </div>
                    )}
            ...
            <div className="flex items-center justify-between">
                ...
                {!saved && (
                    ...
                    {job?.applicationStatus ?(
                        ...
                        !hideApply && (
                            <button
                            className="bg-gradient-to-r from-blue-50 text-sm to-blue-70 text-blue-700 hover:text-white px-6 py-2.5 rounded-xl
                             hover:from-blue-500 hover:to-blue-600 transition-all duration-200 font-semibold transform hover:-translate-y-0.5"
                            onClick={(e)=>{
                                e.stopPropagation();
                                onApply();
                            }}
