                    ...
                    <div className="mb-8 backdrop-blur-sm bg-white/80 border border-white/20 shadow-xl rounded-2xl px-6 pt-6">
                        ...
                        <div className="flex items-center justify-between">
                            ...
                            <button
                                ...
                                className="group flex items-center space-x-2 px-6 py-3 text-xs md:text-sm font-medium text-gray-600
                            hover:text-white bg-white/50 hover:bg-gradient-to-r hover:from-blue-500 hover:to-blue-600 border border-gray-200
                            hover:border-transparent rounded-xl transition-all duration-300 shadow-lg shadow-gray-100 hover:shadow-xl transform hover:-translate-y-0.5"
                            >
                            ...
                            <div className="relative bg-white px-0 pb-8 mt-8 border-b border-gray-100">
                                <div className="relative z-10">
                                    <div className="flex items-start justify-between mb-0">
                                        ...
                                        {user?.companyLogo ? (
                                            <img
                                                ...
                                                alt="Company"
                                                className="h-6 md:h-20 w-16 object-cover rounded-2xl border-4 border-white/20 shadow-lg"
                                            />
                                        ) : (
                                    ...
                                    <div className="flex flex-wrap gap-3 mt-6 md:mt-0">
                                        ...
                                        <span className="px-4 py-2 bg-blue-50 text-sm text-purple-700 font-semibold rounded-full border border-blue-200">
                                            {JOB_TYPES.find((j) => j.value === formData.jobType)?.label}
                                        </span>
                                        <div className="flex items-center space-x-1 px-4 py-2 text-sm text-gray-700 font-semibold rounded-full border border-gray-200">
