...
exports.getJobs = async (req, res) => {
    ...
    try {
        ...
        const jobsWithExtras = jobs.map((job) => {
            ...
            return {
                ...job.toObject(),
                isSaved: savedJobIds.includes(jobIdStr), // kiểm tra lưu
                applicationStatus: appliedJobStatusMap[jobIdStr] || null,//status
            };
        });
